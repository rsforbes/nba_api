...
class EndpointAnalyzer:
    ...
    def _resolve_endpoint(self, endpoint_class_or_name):
        ...
        if isinstance(endpoint_class_or_name, str):
            ...
            try:
                ...
                try:
                    module = __import__(f"nba_api.stats.endpoints.{module_name}", 
    ...
    def _test_required_parameters(self):
        ...
        required_parameters = self.parser.extract_required_parameters(response, self.endpoint_name)
    ...
    def _test_minimal_requirements(self):
        ...
        for param in self.result["required_parameters"]:
            ...
            stored_params = self.parameter_store.get_required_parameters(self.endpoint_name)
    ...
    def _test_nullable_parameters(self):
        ...
        params = {
            param: "" for param in self.result["parameters"]
        ...
        nullable_parameters = [
            param for param in list(params.keys()) 
        ...
        self.result["nullable_parameters"] = list(set(self.result["nullable_parameters"]))
    ...
    def _clean_parameters(self):
        ...
        parameter_overrides = self.parameter_store.get_parameter_overrides(self.endpoint_name)
        ...
        if parameter_overrides:
            for old_param, new_param in parameter_overrides.items():
                ...
                if old_param in self.result["parameter_patterns"]:
                    self.result["parameter_patterns"][new_param] = self.result["parameter_patterns"][old_param]
                    del self.result["parameter_patterns"][old_param]
        
        # Remove any parameters that should not be nullable
        remove_nullable = self.parameter_store.get_remove_nullable_parameters(self.endpoint_name)
